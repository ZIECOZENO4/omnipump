...
import { Modal, Button, Input, Textarea, Avatar, Card, CardBody } from "@nextui-org/react"
    ...
    <div className="p-4 bg-gray-900 text-white min-h-screen">
      {isMdOrLarger ? (
        ...
        <>
          ...
          >
            <Modal.Header className="text-white">Comment on Website</Modal.Header>
            <Modal.Body>
              <CommentForm />
            </Modal.Body>
          </Modal>
      ...
      <Modal 
        ...
        className="bg-gray-800"
      >
        <Modal.Header className="text-white">{selectedComment?.user}'s Comment</Modal.Header>
        <Modal.Body>
