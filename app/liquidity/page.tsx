  ...
  return (
    <div className="py-4 md:px-[10vw] p-4 space-x-8  space-y-8 gap-8 text-[#F7F2DA] min-h-screen">
      ...
      <Card className="border bg-black border-gray-600 p-8">
        <div className='flex flex-col gap-2 text-start space-y-6'>
      ...
      <div className="grid md:grid-cols-2 gap-8  p-8">
        <Card className="border bg-black border-gray-600  space-y-6  space-x-6">
          <CardHeader>
          ...
          <div>
            <div className="space-y-4">
              <div className='flex flex-col gap-4'>
                ...
                <input type="number" id="deposit-amount" placeholder="0.0" className="border h-24 w-full border-gray-200 rounded-md bg-black text-[#F7F2DA]" />
          ...
          <div>
            <div className="space-y-4">
              <div className='flex flex-col gap-4'>
                ...
                <input  type="number" id="withdraw-amount" placeholder="0.0" className="border h-24 w-full border-gray-200 rounded-md bg-black text-[#F7F2DA]" />
      ...
      <Button variant="bordered" className="w-full my-4 hover:bg-green-600 hover:bg-opacity-60  bg-gradient-to-r  from-slate-500 to-slate-700 border border-blue-100 text-[#F7F2DA]">
       Learn More
